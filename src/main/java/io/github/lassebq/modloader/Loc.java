...
public class Loc {
    ...
    public int getBlock(WorldView blockAc) {
        return blockAc.getBlock(this.x(), this.y(), this.z());
    }
    ...
    public Loc setBlock(World world, int blockID) {
        world.setBlockQuietly(this.x(), this.y(), this.z(), blockID);
        return this;
    }

    public int getMeta(WorldView blockAc) {
        return blockAc.getBlockMetadata(this.x(), this.y(), this.z());
    }

    public Loc setMeta(World world, int meta) {
        world.setBlockMetadataQuietly(this.x(), this.y(), this.z(), meta);
        return this;
    }
    ...
    public Loc setBlockAndMeta(World world, int blockID, int meta) {
        world.setBlockWithMetadataQuietly(this.x(), this.y(), this.z(), blockID, meta);
        return this;
    }
    ...
    public BlockEntity getTileEntity(WorldView blockAc) {
    ...
    public int getLight(World world) {
        return world.getLight(this.x(), this.y(), this.z());
    }

    public Loc notify(World world) {
        world.onBlockChanged(this.x(), this.y(), this.z(), this.getBlock(world));
        return this;
    }

    public Loc setSpawnPoint(World world) {
        world.setSpawnPoint(new BlockPos(this.x(), this.y(), this.z()));
        return this;
    }
}
